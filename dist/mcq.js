(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("jquery-ui-dist"), require("vendor"));
	else if(typeof define === 'function' && define.amd)
		define(["jquery-ui-dist", "vendor"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("jquery-ui-dist"), require("vendor")) : factory(root["jquery-ui-dist"], root["vendor"]);
...
exports.McqModelAndView = exports.Constants = undefined;
...
var _mcq = __webpack_require__(18);
...
var McqModelAndView = function () {
    function McqModelAndView(model) {
        _classCallCheck(this, McqModelAndView);

        this.model = model;
    }

    _createClass(McqModelAndView, [{
        key: 'resetView',
        ...
        value: function value() {
            ...
            _rivets2.default.bind($('#mcq-engine'), data);
        }
    }, {
        key: 'template',
        get: function get() {
    ...
    return McqModelAndView;
}();

exports.McqModelAndView = McqModelAndView;
...
var _mcq = __webpack_require__(3);
...
var markCheckBox = Symbol('markCheckBox');

var McqUserResponse = function () {
    function McqUserResponse(mcqObj) {
        _classCallCheck(this, McqUserResponse);

        this.mcqObj = mcqObj;
        __correctAnswers = mcqObj.content.responses;
    }

    _createClass(McqUserResponse, [{
        key: 'savePartial',
        value: function savePartial(interactionid, mcqObj) {
            var _this = this;

            var answerJSONs = null;
            var uniqueId = this.mcqObj.adaptor.getId();
            var counter = 0;

            console.log(' Is it logged twice: ', counter++);
            this.mcqObj.adaptor.sendStatement(uniqueId, (0, _utils2.default)(_mcq.Constants.STATEMENT_INTERACTED));
            answerJSONs = this.__getAnswersJSON(false, interactionid);
            answerJSONs.forEach(function (answerJSON, idx) {
                _this.mcqObj.adaptor.savePartialResults(answerJSON, uniqueId, function (data, status) {
        ...
        key: '__getAnswersJSON',
        value: function __getAnswersJSON(skipQuestion, interactionid) {
            var response = [];
            var filteredInteraction = null;
            var interactiontype = null;
            var mcqmrans = null;
            var mcqsrans = null;

            if ((typeof interactionid === 'undefined' ? 'undefined' : _typeof(interactionid)) === undefined) {
        ...
        key: '__getAnswersJSONMCQMR',
        value: function __getAnswersJSONMCQMR() {
            var _this2 = this;
            ...
            filtered.forEach(function (eachElem, idx) {
                ...
                if (_this2.mcqObj.userAnswers.hasOwnProperty(id)) {
                    if (_this2.mcqObj.userAnswers[id].length === __correctAnswers[id]['correct'].length) {
                        if (_this2.mcqObj.userAnswers[id].sort().join('') === __correctAnswers[id]['correct'].sort().join('')) {
                ...
                resultArray.push({
                    itemUID: id,
                    answer: _this2.mcqObj.userAnswers[id],
                    score: score
                });
            });
        ...
        */
        ...
        key: '__buildFeedbackResponse',
        value: function __buildFeedbackResponse(id, status, content) {
            var feedback = {};
        ...
        key: '__getAnswersJSONMCQSR',
        value: function __getAnswersJSONMCQSR(skipQuestion) {
            var _this3 = this;
            ...
            if (skipQuestion) {
                ...
                filtered.forEach(function (el, idx) {
                    interactionId = el.id;
                    answer = _this3.mcqObj.userAnswers[el.id];

                    if (__correctAnswers[el.id] === _this3.mcqObj.userAnswers[el.id]) {
                        score++;
                    }
                });
            }
        ...
        value: function saveResults(bSubmit) {
            ...
            answerJSONs.forEach(function (answerJSON, idx) {
                ...
                if (bSubmit === true) {
                    ...
                    _this4.mcqObj.adaptor.submitResults(answerJSON, uniqueId, function (data, status) {
                        if (status === __constants.STATUS_NOERROR) {
                            __state.activitySubmitted = true;
                            /*Close platform's session*/
                            _this4.mcqObj.adaptor.closeActivity();
        ...
        */
        ...
        value: function value() {
            ...
            if (type === 'MCQMR') {
                ...
                for (interaction in __correctAnswers) {
                    if (__correctAnswers.hasOwnProperty(interaction)) {
                        for (var j = 0; j < __correctAnswers[interaction]['correct'].length; j++) {
            ...
            if (type === 'MCQSR') {
                ...
                var interactionid = Object.keys(__correctAnswers);

                if (interactionid) {

                    var correctAnswer = __correctAnswers[interactionid]['correct'];
                    var userAnswer = this.mcqObj.userAnswers[interactionid];
        ...
        value: function feedbackProcessor() {
            ...
            isCorrect = function isCorrect(answerjson, useranswerjson) {
                var isCorrect = false;
                var countCorrectInteractionAttempt = 0;
                ...
                _this5.mcqObj.adaptor.autoResizeActivityIframe();
                return isCorrect;
            };
            if (type === 'MCQMR') {
                for (var prop in this.mcqObj.mcqModel.feedback) {
                    this.mcqObj.mcqModel.feedbackState[prop] = false;
                }
                var keys = Object.keys(this.mcqObj.userAnswers);
            ...
            if (type === 'MCQSR') {
                Object.keys(__correctAnswers).forEach(function (elem, idx) {
                    ...
                    var userAnswer = _this5.mcqObj.userAnswers[elem];

                    if (userAnswer === correctAnswer) {
                        _this5.mcqObj.mcqModel.feedbackState.correct = true;
                        _this5.mcqObj.mcqModel.feedbackState.incorrect = false;
                        _this5.mcqObj.mcqModel.feedbackState.empty = false;
                    } else {
                        _this5.mcqObj.mcqModel.feedbackState.correct = false;
                        _this5.mcqObj.mcqModel.feedbackState.incorrect = true;
                        _this5.mcqObj.mcqModel.feedbackState.empty = false;
                    }
                    ...
                    if (userAnswer === '') {
                        _this5.mcqObj.mcqModel.feedbackState.correct = false;
                        _this5.mcqObj.mcqModel.feedbackState.incorrect = false;
                        _this5.mcqObj.mcqModel.feedbackState.empty = true;
                    }
                });
            }
    ...
    return McqUserResponse;
}();

exports.default = McqUserResponse;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
exports.mcq = undefined;

var _mcq = __webpack_require__(16);

var _mcq2 = _interopRequireDefault(_mcq);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.mcq = _mcq2.default;
...
var _mcq = __webpack_require__(17);

var _mcq2 = _interopRequireDefault(_mcq);

var _mcq3 = __webpack_require__(3);

var _mcq4 = __webpack_require__(21);

var _mcq5 = _interopRequireDefault(_mcq4);

var _mcq6 = __webpack_require__(10);

var _mcq7 = _interopRequireDefault(_mcq6);
...
var mcq = function () {
    ...
    */
    function mcq(elRoot, params, adaptor, htmlLayout, jsonContentObj, callback) {
        _classCallCheck(this, mcq);

        adaptor.sendStatement(adaptor.getId(), (0, _utils2.default)(_mcq3.Constants.STATEMENT_STARTED));
        this.elRoot = elRoot;
        this.params = params;
        ...
        this[load]();
        if (callback) {
            callback({ backgroundColor: _mcq3.Constants.LAYOUT_COLOR.BG[htmlLayout] });
        }
    }
    ...
    _createClass(mcq, [{
        ...
        key: transform,
        value: function value() {
            var mcqTransformer = new _mcq2.default(this.content, this.params, this.theme);
        ...
        key: renderView,
        value: function value() {
            mcqModelAndView = new _mcq3.McqModelAndView(this.mcqModel);
            var htmltemplate = mcqModelAndView.template;
        ...
        key: bindEvents,
        value: function value() {
            var mcqEvents = new _mcq5.default(this);
        ...
        */
        ...
        value: function handleSubmit() {
            var mcqResponseProcessor = new _mcq7.default(this);
            ...
            this.adaptor.sendStatement(this.adaptor.getId(), (0, _utils2.default)(_mcq3.Constants.STATEMENT_SUBMITTED));
        }
    }, {
        key: 'showGrades',
        ...
        key: 'clearGrades',
        value: function clearGrades() {
            var keys = Object.keys(this.userAnswers);
...
var McqTransformer = function () {
    function McqTransformer(entity, params, themeObj) {
        _classCallCheck(this, McqTransformer);
    ...
    _createClass(McqTransformer, [{
        ...
        value: function value(themeKey) {
            this.mcqModel.theme = _mcq.Constants.THEMES[themeKey];
        }
    }, {
        key: setInstructions,
        value: function value() {
    ...
    return McqTransformer;
}();

exports.default = McqTransformer;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var _mcq = __webpack_require__(10);
...
var McqEvents = function () {
    function McqEvents(mcqObj) {
        _classCallCheck(this, McqEvents);

        this.McqInstance = mcqObj;
        this.mcqResponseProcessor = new _mcq2.default(mcqObj);
    }

    _createClass(McqEvents, [{
        key: 'bindEvents',
        value: function bindEvents() {
            var _this = this;

            var __remove = void 0;
            var __handleCheckboxClick = void 0;
            var __handleRadioButtonClick = void 0;

            __remove = function __remove(arr, value) {
            ...
            */
            __handleCheckboxClick = function __handleCheckboxClick(event) {
                ...
                if (currentTarget.checked) {
                    ...
                    console.log('not loading', _this.McqInstance);
                    if (!_this.McqInstance.userAnswers[currentInteractionId]) {
                        _this.McqInstance.userAnswers[currentInteractionId] = [];
                    }

                    _this.McqInstance.userAnswers[currentInteractionId].push(currentChoice);
                    console.log(_this.McqInstance.userAnswers, currentInteractionId, currentChoice);
                } else {
                    __remove(_this.McqInstance.userAnswers[currentInteractionId], currentChoice);
                    $(currentTarget).closest('li').removeClass('highlight');
                }
                _this.mcqResponseProcessor.savePartial(currentInteractionId, _this.McqInstance);
            ...
            __handleRadioButtonClick = function __handleRadioButtonClick(event) {
                var currentTarget = event.currentTarget;
                ...
                _this.McqInstance.userAnswers[currentInteractionId] = $(event.currentTarget).children('input').attr('id');
                console.log(JSON.stringify(_this.McqInstance.userAnswers, null, 4));
                _this.mcqResponseProcessor.savePartial(currentInteractionId, _this.McqInstance);
