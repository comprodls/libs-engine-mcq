...
/* WEBPACK VAR INJECTION */(function(jQuery, $) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mcq6Editor", function() { return mcq6Editor; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mcqeditor_utils_js__ = __webpack_require__(17);
/* global $ */
/* global jQuery */
...
class mcq6Editor {
  ...
  constructor(elRoot, params, adaptor, htmlLayout, jsonContentObj, callback) {
    ...
    * Store the adaptor.
    */
    __WEBPACK_IMPORTED_MODULE_0__mcqeditor_utils_js__["h" /* setAdaptor */](adaptor);

    __WEBPACK_IMPORTED_MODULE_0__mcqeditor_utils_js__["b" /* buildModelandViewContent */](this.jsonContent, params);
    /**
      * @member {String}
      * Apply the content JSON to the htmllayout.
      */
    $(elRoot).html(__WEBPACK_IMPORTED_MODULE_0__mcqeditor_utils_js__["a" /* __constants */].TEMPLATES[htmlLayout]);

    /**
      * Update the DOM and render the processed HTML - main body of the activity.
      */
    __WEBPACK_IMPORTED_MODULE_0__mcqeditor_utils_js__["f" /* initializeRivets */]();

    /**
      * Register the click events
      */
    __WEBPACK_IMPORTED_MODULE_0__mcqeditor_utils_js__["e" /* initializeHandlers */]();
  ...
  getConfig() {
    __WEBPACK_IMPORTED_MODULE_0__mcqeditor_utils_js__["c" /* getConfig */]();
  }

  getStatus() {
    __WEBPACK_IMPORTED_MODULE_0__mcqeditor_utils_js__["d" /* getStatus */]();
  }

  saveItemInEditor() {
    __WEBPACK_IMPORTED_MODULE_0__mcqeditor_utils_js__["g" /* saveItemInEditor */]();
  }
}
...
"use strict";
/* WEBPACK VAR INJECTION */(function(jQuery, $) {/* unused harmony export setJsonContent */
/* harmony export (immutable) */ __webpack_exports__["c"] = getConfig;
/* harmony export (immutable) */ __webpack_exports__["d"] = getStatus;
/* harmony export (immutable) */ __webpack_exports__["g"] = saveItemInEditor;
/* unused harmony export __parseAndUpdateJSONForRivets */
/* unused harmony export __parseAndUpdateJSONForInteractions */
/* harmony export (immutable) */ __webpack_exports__["b"] = buildModelandViewContent;
/* unused harmony export __handleItemChangedInEditor */
/* harmony export (immutable) */ __webpack_exports__["f"] = initializeRivets;
/* harmony export (immutable) */ __webpack_exports__["h"] = setAdaptor;
/* harmony export (immutable) */ __webpack_exports__["e"] = initializeHandlers;
...
let mcqTemplateRef = __webpack_require__(18);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = __constants;
...
let uniqueId;
let __feedbackPresets = [{ key: 'correct', value: 'Show when Correct', showDropdown: true, order: 1 }, { key: 'incorrect', value: 'Show when Incorrect', showDropdown: true, order: 2 }, { key: 'generic', value: 'Show Always', showDropdown: true, order: 100 }];

let __mediaPresets = [{ key: 'audio', value: 'Audio', showDropdown: true, active: 'disabled color-lightgray', order: 1, icon: 'fa-volume-up' }, { key: 'image', value: 'Image', showDropdown: true, active: 'enabled color-gray', order: 2, icon: 'fa-picture-o' }, { key: 'video', value: 'Video', showDropdown: true, active: 'disabled color-lightgray', order: 100, icon: 'fa-video-camera' }];
...
function __appendMedia(event, type) {
    ...
    __mediaManager.getAssetLibrary().getAssets(type.toLowerCase(), { 'skip': 0,
        'limit': 4
    }, function (err, data) {
        if (err) {
            console.log(err);
...
function __finalizeAssets(args) {
    ...
    if (__imageSelected.isImageSelected) {
        let finalizedAssets = __createAssetsObj(__imageSelected.stimulus[0], __imageSelected.key);
...
function initializeRivets() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_rivets___default.a.formatters.args = function (fn) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_rivets___default.a.formatters.appendindex = function (obj, index) {
        var array = [];
    ...
    __WEBPACK_IMPORTED_MODULE_0_rivets___default.a.formatters.idcreator = function (key, idvalue) {
        return idvalue + key;
    };

    __WEBPACK_IMPORTED_MODULE_0_rivets___default.a.formatters.btnId = function (obj) {
        var text = 'btn';
    ...
    __WEBPACK_IMPORTED_MODULE_0_rivets___default.a.formatters.formatDate = function (timeInMilliSec) {
        let d = new Date(timeInMilliSec);

        return d;
    };

    __WEBPACK_IMPORTED_MODULE_0_rivets___default.a.formatters.interactTypeVal = function (key) {
        var types = {
    ...
    __WEBPACK_IMPORTED_MODULE_0_rivets___default.a.formatters.assets = function (url) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_rivets___default.a.formatters.assetname = function (url) {
        let name = url.substring(url.lastIndexOf('/') + 1);

        return name;
    };

    __WEBPACK_IMPORTED_MODULE_0_rivets___default.a.binders['content-editable'] = {
        bind: function (el) {
            var that = this;
...
//# sourceMappingURL=mcq6-editor.js.map